      ...
      try {
        ...
        setMeta({
          categories: Array.isArray(r.data?.categories)
            ? r.data.categories
            : [],
          conditions: Array.isArray(r.data?.conditions)
            ? r.data.conditions
            : [],
        });
      } catch (err) {
  ...
  return (
    ...
    >
      <div className="flex items-end justify-between mb-6">
        <div>
          <p className="text-xs uppercase tracking-[0.15em] font-bold text-[#4B5563]">
            EduSwap Marketplace
          </p>
      ...
      {loading ? (
        <div className="py-20 text-center font-bold uppercase tracking-wider">
          Loading...
        </div>
      ) : !Array.isArray(listings) ||
        listings.length === 0 ? (
        <div
          className="bg-white border-2 border-black rounded-lg p-10 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
